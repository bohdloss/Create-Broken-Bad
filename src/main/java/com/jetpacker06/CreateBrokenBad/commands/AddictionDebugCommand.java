...
public class AddictionDebugCommand {
    ...
    private static int show(CommandContext<CommandSourceStack> context) {
        try {
            ...
            player.getCapability(CBBCapabilities.PLAYER_ADDICTION).ifPresent(addiction -> {
                player.displayClientMessage(Component.translatable("commands.createbb.addiction.show",
    ...
    private static int clear(CommandContext<CommandSourceStack> context) {
        try {
            ...
            player.getCapability(CBBCapabilities.PLAYER_ADDICTION).ifPresent(addiction -> {
                addiction.reset();
                player.displayClientMessage(Component.translatable("commands.createbb.addiction.clear"), true);
            });
    ...
    private static int setAddiction(CommandContext<CommandSourceStack> context) {
        try {
            ...
            player.getCapability(CBBCapabilities.PLAYER_ADDICTION).ifPresent(addiction -> {
                ...
                player.displayClientMessage(Component.translatable("commands.createbb.addiction.set_addiction", "" + ChatFormatting.YELLOW + value), true);
            });
    ...
    private static int setWithdrawal(CommandContext<CommandSourceStack> context) {
        try {
            ...
            player.getCapability(CBBCapabilities.PLAYER_ADDICTION).ifPresent(addiction -> {
                ...
                player.displayClientMessage(Component.translatable("commands.createbb.addiction.set_withdrawal", "" + ChatFormatting.YELLOW + value), true);
            });
    ...
    private static int setTolerance(CommandContext<CommandSourceStack> context) {
        try {
            ...
            player.getCapability(CBBCapabilities.PLAYER_ADDICTION).ifPresent(addiction -> {
                ...
                player.displayClientMessage(Component.translatable("commands.createbb.addiction.set_tolerance", "" + ChatFormatting.YELLOW + value), true);
            });
    ...
    private static int setToxicity(CommandContext<CommandSourceStack> context) {
        try {
            ...
            player.getCapability(CBBCapabilities.PLAYER_ADDICTION).ifPresent(addiction -> {
                ...
                player.displayClientMessage(Component.translatable("commands.createbb.addiction.set_toxicity", "" + ChatFormatting.YELLOW + value), true);
            });
